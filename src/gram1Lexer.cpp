...
#include "gram1Lexer.h"


using namespace antlr4;


gram1Lexer::gram1Lexer(CharStream *input) : Lexer(input) {
  _interpreter = new atn::LexerATNSimulator(this, _atn, _decisionToDFA, _sharedContextCache);
}

gram1Lexer::~gram1Lexer() {
  delete _interpreter;
}

std::string gram1Lexer::getGrammarFileName() const {
  return "gram1.g4";
}

const std::vector<std::string>& gram1Lexer::getRuleNames() const {
  return _ruleNames;
}

const std::vector<std::string>& gram1Lexer::getChannelNames() const {
  return _channelNames;
}

const std::vector<std::string>& gram1Lexer::getModeNames() const {
  return _modeNames;
}

const std::vector<std::string>& gram1Lexer::getTokenNames() const {
  return _tokenNames;
}

dfa::Vocabulary& gram1Lexer::getVocabulary() const {
  return _vocabulary;
}

const std::vector<uint16_t> gram1Lexer::getSerializedATN() const {
  return _serializedATN;
}

const atn::ATN& gram1Lexer::getATN() const {
  return _atn;
}
...
std::vector<dfa::DFA> gram1Lexer::_decisionToDFA;
atn::PredictionContextCache gram1Lexer::_sharedContextCache;

// We own the ATN which in turn owns the ATN states.
atn::ATN gram1Lexer::_atn;
std::vector<uint16_t> gram1Lexer::_serializedATN;

std::vector<std::string> gram1Lexer::_ruleNames = {
  u8"T__0", u8"T__1", u8"T__2", u8"T__3", u8"NOMBRE"
};

std::vector<std::string> gram1Lexer::_channelNames = {
  "DEFAULT_TOKEN_CHANNEL", "HIDDEN"
};

std::vector<std::string> gram1Lexer::_modeNames = {
  u8"DEFAULT_MODE"
};

std::vector<std::string> gram1Lexer::_literalNames = {
  "", u8"'int main() {'", u8"'}'", u8"'return'", u8"';'"
};

std::vector<std::string> gram1Lexer::_symbolicNames = {
  "", "", "", "", "", u8"NOMBRE"
};

dfa::Vocabulary gram1Lexer::_vocabulary(_literalNames, _symbolicNames);

std::vector<std::string> gram1Lexer::_tokenNames;

gram1Lexer::Initializer::Initializer() {
...
gram1Lexer::Initializer gram1Lexer::_init;
